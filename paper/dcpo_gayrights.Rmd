...
Abstract wordcount: 163 words

Manuscript wordcount: XXXX words
\pagebreak
...
Supporting this view, its analysis found that more economic inequality leads to less positive attitudes toward gay and lesbian people, as measured by the ten-point World Values Survey item on the justifiability of homosexuality mentioned above.
...
The measurement uncertainty in the data for both attitudes toward gay and lesbian people and income inequality was incorporated into the analysis as well [see @Tai2022].
...
In the short run, a two-standard-deviation year-to-year change was found to decrease support `r get_coef("gini_diff", type = "std_coef") %>% str_remove("-")` points (95% c.i.:`r get_coef("gini_diff", type = "ci")`) among democracies.
