...
```{r internalval, fig.height=4, fig.width=7.5, fig.cap = "Convergent Validation: Correlations Between AoH Scores and Individual Source-Data Survey Items \\label{internal_val}"}
...
```{r extval1, fig.cap="Construct Validation: Correlations Between AoH Scores and Acceptance of Homosexuality Survey Items \\label{ext_val1}", fig.height=4, fig.width=7.5}
...
@Andersen2008 [35 countries, 63 country-years]

@Zhang2019 [88 countries, 214 country-years]
