...
# set eval to TRUE to run; running time is >2 hours
iter <- 1500
...
An alternate theory would be that greater inequality gives wealthier individuals both greater means and motive to promote religiosity among their fellow citizens [see, e.g., @Solt2011a; @Solt2014a], and more religiosity in turn works to decrease tolerance [see, e.g., @Adamczyk2009].  We leave distinguishing between these two theories to future research.]
