...
The piece argues that postmaterialist theory [see, e.g., @Inglehart2005] implies that greater inequality should be expected to yield greater intolerance of homosexuality: if economic prosperity is what allows societies to leave such traditional biases behind, then when a society's prosperity is not broadly shared, more tolerant attitudes will not be broadly shared either.^[
An alternate theory would be that greater inequality gives wealthier individuals both greater means and motive to promote religiosity among their fellow citizens [see, e.g., @Solt2011a; @Solt2014b], and more religiosity in turn works to decrease tolerance [see, e.g., @Adamczyk2009].  We leave distinguishing between these two theories to future research.]
