...
gm_laws_bd <- read_csv("data-raw/gm_laws.csv",
                    col_types = "cddddddc") %>% 
...
As a result of policy responsiveness, that is, the influence of public opinion on policy [see, e.g., @Lax2009], and policy feedback, the influence of policy on public opinion [see, e.g., @Abou-Chadi2019], public acceptance of homosexuality is expected to be closely related to policies recognizing same-sex relationships.
...
if (!file.exists(here("data-raw", "ElectionIndices.pdf"))) {
  download.file("https://www.tcd.ie/Political_Science/people/michael_gallagher/ElSystems/Docts/ElectionIndices.pdf", 
...
Taken as a whole, this evidence indicates that it is good times, not bad ones, that yield higher macrointerest.
