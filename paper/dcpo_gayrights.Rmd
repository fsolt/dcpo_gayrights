...
As an example of the utility of the TOLH data, we revisit Andersen and Fetner's [-@Andersen2008] foundational work.
The piece argues that postmaterialist theory [see, e.g., @Inglehart2005] implies that greater inequality should be expected to yield greater intolerance of homosexuality: if economic development is what allows societies to leave such biases behind, then when a society's prosperity is not broadly shared, more accepting attitudes will not be broadly shared either.
Supporting this view, its analysis found that more economic inequality leads to more intolerance of homosexuality.
Despite this article's influence, this conclusion was flagged by 
@Adamczyk2019 [, 415] in a recent review of the literature as one for which "more research is needed to replicate and confirm these findings."
Indeed, recent work found no support at all for this relationship between inequality and attitudes toward homosexuality [@Zhang2019, 515].

One difference between these two works, potentially important to their diverging conclusions, is the sample employed.
Although both works draw on World Values Survey data, the groups of countries they examine differ in kind and in size.
...
The TOLH data allows us to revisit this hypothesis with much, much more data

us: 199 countries, 


To test these hypotheses, we use the following data.
...
A series of country-level variables to identify a country's religious heritage are also dichotomous: countries are coded as having alternately a Catholic, Orthodox, Eastern, or Islamic heritage.
(Countries with a Protestant heritage are treated as the reference category.)
